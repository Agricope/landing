export function ComingSoon() {
  return (
    <div className="flex flex-col lg:flex-row min-h-screen w-full bg-gradient-to-br from-[#8FDE95] to-[#E8F8E9]">
      ...
      <div className="w-full lg:w-[45%] flex flex-col justify-center items-center lg:items-start px-8 sm:px-12 lg:px-16 xl:px-24 py-12 lg:py-0 min-h-screen lg:min-h-screen lg:-mt-32">
        {/* Logo */}
        <div className="mb-12 lg:mb-44">
          <img
            src="/logo.svg"
            alt="Agricope Logo"
        ...
        {/* Heading */}
        <h1 className="font-inter font-extrabold text-primary-green leading-tight mb-6 whitespace-nowrap text-center lg:text-left" style={{ fontSize: "clamp(2.5rem, 5vw, 5rem)" }}>
      ...
      {/* Right Side - Image */}
      <div className="hidden lg:block lg:w-[55%] lg:h-screen pl-42 py-0 pr-8">
        <img
